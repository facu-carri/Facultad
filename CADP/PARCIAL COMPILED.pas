...
begin
    ...
    while(l <> nil)do begin
        ...
        for i := 1 to c.dimL do begin
            ...
            if(c.cuentas[i].cbu = 123) and (c.nro = 777)then begin
        ...
        else if(c.dimL < min2) then begin
            min2 := c.dimL;
            nro2 := c.nro;
        end;
        WriteLn('Los dos numeros de clientes con menor numero de cuentas son ', nro1, ' y ', nro2);
